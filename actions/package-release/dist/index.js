...
const {gitmojis} = __webpack_require__(535);
const simpleGit = __webpack_require__(332);
...
var init_util = __esm({
  "src/lib/utils/util.ts"() {
    import_file_exists = __webpack_require__(637);
    NULL = "\0";
    NOOP = () => {
    };
...
var init_completion_detection_plugin = __esm({
  "src/lib/plugins/completion-detection.plugin.ts"() {
    import_promise_deferred = __webpack_require__(435);
    init_utils();
...
var init_git_logger = __esm({
  "src/lib/git-logger.ts"() {
    import_debug = __toESM(__webpack_require__(25));
    init_utils();
...
var init_scheduler = __esm({
  "src/lib/runners/scheduler.ts"() {
    init_utils();
    import_promise_deferred2 = __webpack_require__(435);
    init_git_logger();
    createScheduledTask = (() => {
      let id = 0;
      return () => {
...
function setup(env) {
	...
	createDebug.enable = enable;
	createDebug.enabled = enabled;
	createDebug.humanize = __webpack_require__(985);
	createDebug.destroy = destroy;
...
module.exports = __webpack_require__(614)(exports);
...
const debug_1 = __importDefault(__webpack_require__(419));
